...
class TestAoC(unittest.TestCase):
    ...
    def test_day2_part2(self):
        self.assertEqual(aoc.aoc.run_day(2, 2, get_default_test_input(2)), 1)

    def test_day3_part1(self):
        self.assertEqual(aoc.aoc.run_day(3, 1, get_default_test_input(3)), 7)

    def test_day3_part2(self):
        self.assertEqual(aoc.aoc.run_day(3, 2, get_default_test_input(3)), 336)

    def test_day4_part1(self):
        self.assertEqual(aoc.aoc.run_day(4, 1, get_default_test_input(4)), 2)

    def test_day4_part2(self):
        self.assertEqual(aoc.aoc.run_day(4, 2, get_default_test_input(4)), 2)

    def test_day5_part1(self):
        self.assertEqual(aoc.aoc.run_day(5, 1, get_default_test_input(5)), 820)

    def test_day5_part2(self):
        self.assertIsNone(aoc.aoc.run_day(5, 2, get_default_test_input(5)))

    def test_day6_part1(self):
        self.assertEqual(aoc.aoc.run_day(6, 1, get_default_test_input(6)), 11)

    def test_day6_part2(self):
        self.assertEqual(aoc.aoc.run_day(6, 2, get_default_test_input(6)), 6)
    ...
    def test_day8_part1(self):
        self.assertEqual(aoc.aoc.run_day(8, 1, get_default_test_input(8)), 5)

    def test_day8_part2(self):
        self.assertEqual(aoc.aoc.run_day(8, 2, get_default_test_input(8)), 8)
